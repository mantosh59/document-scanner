 ...
 */
@available(iOS 13.0, *)
@objc(EGDocScannerPlugin)
public class EGDocScannerPlugin: CAPPlugin, CAPBridgedPlugin {
    public let identifier = "EGDocScannerPlugin"
    public let jsName = "EGDocScanner"
...
//    private let implementation = EGDocScanner()
    ...
    let documentScanner: EGDocScanner = EGDocScanner()
